...
class App extends Component {
  constructor() {
    super();
    this.state = {
      hand: ["face_down", "face_down", "face_down", "face_down", "face_down", "face_down"]
    }
  }
  ...
  flipTheCards () {
    ...
    cards.splice();
    this.setState({
      hand: [cards[1], cards[2], cards[3], cards[4], cards[5], cards[6]]
    })
  }

  render() {
    let card1Image = "http://golearntocode.com/images/cards/" + this.state.hand[1] + ".png";
    let card2Image = "http://golearntocode.com/images/cards/" + this.state.hand[2] + ".png";
    let card3Image = "http://golearntocode.com/images/cards/" + this.state.hand[3] + ".png";
    let card4Image = "http://golearntocode.com/images/cards/" + this.state.hand[4] + ".png";
    let card5Image = "http://golearntocode.com/images/cards/" + this.state.hand[5] + ".png";
    return (
      <div className="App">
        <h1>
          <img src={card1Image} />
        ...
        <p><a href="#" onClick={() => this.flipTheCards()}><button>Deal a new hand</button></a></p>
      </div>
    );
  }
}
